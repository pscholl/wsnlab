...
class imu_edison {
 public:
  ...
  imu_edison(uint8_t i2c_addr = MPU_I2C_ADDR, bool init_env = false);
  ...
  std::vector<float> convertData_1tor(std::vector<int8_t> in);
  std::vector<float> convertData_2tor(std::vector<int16_t> in);
